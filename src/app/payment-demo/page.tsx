      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            This demo showcases the complete Stripe payment integration for subscription-based services.
            Select a plan and complete the payment process.
          </p>
        </div>
        ...
        <div className="mt-16 bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Create Subscription</h3>
              <p className="text-gray-600">
                Your backend creates a subscription and returns a payment intent with client secret.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Create Payment Method</h3>
              <p className="text-gray-600">
                Stripe creates a payment method using the card details provided by the user.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                The payment intent is confirmed using the client secret and payment method ID.
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 p-6 bg-gray-50 rounded-lg">
            ...
            <div className="space-y-3 text-sm text-gray-700">
              <p><strong>Backend API:</strong> http://172.252.13.71:1002/api/v1/billing/subscribe</p>
              <p><strong>Stripe API:</strong> https://api.stripe.com/v1/payment_methods & /payment_intents/:id/confirm</p>
              <p><strong>Authentication:</strong> Bearer Token for backend, Basic Auth for Stripe</p>
              <p><strong>Plan ID:</strong> Currently using static plan ID: 688b48b5f92ece73d804c01d</p>
            </div>
          </div>
        </div>
      </div>
