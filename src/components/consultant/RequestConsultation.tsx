...
const RequestConsultation: React.FC = () => {
    ...
    const handleInputChange = (field: keyof RequestConsultationFormData, value: string) => {
        ...
        <div className='min-h-screen'>
            ...
            <div className="bg-white flex flex-col items-center justify-center px-4 py-12">
                <div className="max-w-[1440px] mx-auto w-full bg-white p-2 md:p-8">
                    {/* Step Info */}
                    <p className="text-center text-[1rem] text-info font-medium mb-2">Request Expert Consultation</p>

                    <div className="text-center mb-8">
                        <h2 className="text-[2rem] text-accent font-medium">
                            Let us know how we can<br />assist you further
                        </h2>
                        <p className="text-[1rem] text-gray-600 mt-4 max-w-2xl mx-auto">
                            Our expert consultants will review your request and respond shortly.
                        </p>
                    </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="mt-4 space-y-4">
                                        ...
                                        <div>
                                            <div className={`flex items-center p-4 border-2 rounded-lg cursor-pointer hover:bg-gray-50 ${
                                                formData.businessType === 'existing' ? 'border-primary' : 'border-gray-200'
                                            }`} onClick={() => setFormData({ ...formData, businessType: 'existing' })}>
                                                <div className={`w-4 h-4 rounded-full border-2 mr-3 ${
                                                    formData.businessType === 'existing' ? 'border-[#A9A4FE] bg-primary' : 'border-primary bg-white'
                                                }`}></div>
                                                <span className="text-[1rem] font-normal text-accent">Existing Business</span>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            <div className={`flex items-center p-4 border-2 rounded-lg cursor-pointer hover:bg-gray-50 ${
                                                formData.businessType === 'startup' ? 'border-primary' : 'border-gray-200'
                                            }`} onClick={() => setFormData({ ...formData, businessType: 'startup' })}>
                                                <div className={`w-4 h-4 rounded-full border-2 mr-3 ${
                                                    formData.businessType === 'startup' ? 'border-[#A9A4FE] bg-primary' : 'border-primary bg-white'
                                                }`}></div>
                                                <span className="text-[1rem] font-normal text-accent">Startup</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent resize-none ${
                                            errors.description ? 'border-red-500' : 'border-[#888888]/50'
                                        }`}
                                        required
                                    />
                                    {errors.description && (
                                ...
                                <div>
                                    ...
                                    {!uploadSuccess && (
                                        <div className="flex items-center gap-2 cursor-pointer mt-3" onClick={() => document.getElementById('file-upload')?.click()}>
                                            <div className='bg-gray-50 p-3 rounded-full'>
                                                <GrAttachment className='text-primary' />
                                            </div>
                                            <span className="text-sm text-gray-600">Attach business documents</span>
                                            <input
                                                id="file-upload"
                                                type="file"
                                                multiple
                                        ...
                                        <div className="mt-3 space-y-2">
                                            {formData.documents.map((file, index) => (
                                                <div key={index} className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-sm text-green-600">{file.name} uploaded successfully</span>
                                                    <button
                                                        type="button"
                                ...
                                <div className="pt-6 flex justify-center gap-4 max-w-md mx-auto">
                                    {/* Back Button */}
                                    <Link href="/approved-plan" className="block">
                                        <button
                                            type="button"
                                    ...
                                    <button
                                        type="submit"
                                        className="bg-purple-600 hover:bg-purple-700 cursor-pointer text-white font-semibold py-3 px-6 rounded-lg transition-all duration-200 transform hover:scale-[1.02] text-[1rem]"
                                    >
                                        Send Request
                                    </button>
                                </div>
