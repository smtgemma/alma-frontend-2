...
const PlanApprovedbyAdmin: React.FC<PlanApprovedbyAdminProps> = ({
  ...
  const defaultContent = {
    ...
    financialProjections:
      "Projected revenue growth of 300% over 3 years with strong market penetration in the SaaS sector.",
    marketingStrategy:
      "Multi-channel approach including digital marketing, partnerships, and thought leadership content.",
    riskAnalysis:
      "Market competition and technology evolution are primary risks, mitigated through continuous innovation and customer feedback loops.",
  };
  ...
  const defaultProps = {
    ...
    marketingSalesStrategy:
      marketingSalesStrategy || content.marketingStrategy || "",
    ...
    <div className="min-h-screen bg-white">
      ...
      <div id="businessplan" className="max-w-[1440px] mx-4 xl:mx-auto">
        <GeneratedBusinessPlanforAdmin
          executiveSummary={defaultProps.executiveSummary}
          businessOverview={defaultProps.businessOverview}
          marketAnalysis={defaultProps.marketAnalysis}
        />
        <FinancialDashboard
        ...
        <OperationsDashboard
          ...
          keyRatios={defaultProps.keyRatios}
          operatingCostBreakdown={defaultProps.operatingCostBreakdown}
        />
