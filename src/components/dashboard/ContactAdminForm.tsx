        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-100">
          <div className="px-6 py-5 border-b border-gray-100">
            ...
            <p className="text-sm text-gray-600 mt-1">
              Have a question about Pianifico? Send us a message and we’ll get
              back to you.
            </p>
          </div>
          ...
          <form onSubmit={onSubmit} className="p-6 grid grid-cols-1 gap-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  name="name"
                  type="text"
                  className={`input w-full ${errors.name ? "border-red-400 focus:ring-red-300" : ""}`}
              ...
              <div>
                ...
                <input
                  name="email"
                  type="email"
                  className={`input w-full ${errors.email ? "border-red-400 focus:ring-red-300" : ""}`}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  name="phone"
                  type="tel"
                  className={`input w-full ${errors.phone ? "border-red-400 focus:ring-red-300" : ""}`}
              ...
              <div>
                ...
                <input
                  name="subject"
                  type="text"
                  className={`input w-full ${errors.subject ? "border-red-400 focus:ring-red-300" : ""}`}
                  placeholder="Inquiry about Pianifico"
                  value={form.subject}
                  onChange={onChange}
                  disabled={submitting}
                />
            ...
            <div>
              ...
              <textarea
                name="message"
                className={`input w-full min-h-32 ${errors.message ? "border-red-400 focus:ring-red-300" : ""}`}
                placeholder="Hi, I would love to learn more about Pianifico!"
                value={form.message}
                onChange={onChange}
                disabled={submitting}
              />
