...
const BusinessPlan = () => {
  ...
  return (
    <div className="min-h-screen  bg-white ">
          ...
          <section>
            ...
            <div className="space-y-3 text-gray-700 leading-relaxed">
              ...
              <p>
                ...
                repellat. Temporibus autem quibusdam et aut officiis debitis aut
      ...
      <div className=" max-w-[1440px] mx-auto fixed bottom-8 right-8 flex justify-end gap-4">
        {/* Share Button */}
        <button
          onClick={handleSocialShareClick}
          className="w-14 h-14 bg-primary rounded-full shadow-lg hover:bg-primary/90 transition-colors flex items-center justify-center text-white"
        ...
        <button
          onClick={() => {
            // Create the business plan content
            const businessPlanContent = `Business AI Plan
...
Maiores alias consequatur aut perferendis doloribus asperiores repellat. Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae.

Generated on: ${new Date().toLocaleDateString()}
Generated by: Business AI Plan Generator`;

            // Create a blob with the content
            const blob = new Blob([businessPlanContent], {
              type: "text/plain",
            });
            ...
            link.href = url;
            link.download = `Business_AI_Plan_${
      ...
      <SocialShareModal
        ...
        description="Check out this amazing business plan generated by AI! This comprehensive plan includes business overview, competitive advantage, and strategic insights."
      />
    </div>
  );
};
